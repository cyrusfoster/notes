...
\text{arg}_\text{lat} = \nu + \omega
\quad
\sin\text{arg}_\text{lat} = \frac{\sin\text{lat}}{\sin\text{inc}}
$
$\quad$
Hyperbolic:
$
...
\\ \frac{1}{2} \bm q \begin{bmatrix} 0 \\ \bm\omega \end{bmatrix}_{\text{quat}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{\underline{Components}}

\import{svg/}{theta_angle.pdf_tex}
\import{svg/}{theta_angle_offperi.pdf_tex}
\import{svg/}{stay_elliptical.pdf_tex}
\import{svg/}{bielliptic.pdf_tex}
\import{svg/}{inject_templates.pdf_tex}
\import{svg/}{azimuth.pdf_tex}
